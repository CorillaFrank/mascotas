import type { Color, Mascota, VariantProduct } from '../interfaces';
...
export const prepareProducts = (mascots: Mascota[]) => {
	return mascots.map(mascota => {
		// Agrupar las variantes por color
		const colors = mascota.variants.reduce(
